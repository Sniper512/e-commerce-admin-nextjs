...
import { ProductOrderSearchDropdown } from "@/components/features/payments/product-order-search-dropdown";
...
export function OrderCreateForm({
  ...
  const handleProductSelect = (product: ProductWithStock) => {
    ...
    // Use pre-calculated discount from server
    const productDiscount = product.discountAmount;
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <ProductOrderSearchDropdown
                    products={products}
                    onSelect={handleProductSelect}
                    excludeIds={orderItems.map((item) => item.productId)}
                  />
                </div>
