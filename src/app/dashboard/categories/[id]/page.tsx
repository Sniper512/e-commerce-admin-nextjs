        ...
        return (
            <DashboardLayout>
                <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
                    ...
                    <p className="text-lg text-gray-600">{error || 'Category not found'}</p>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 mt-1">
                                {isEditing ? 'Update category details' : 'View and manage category'}
                            </p>
                        </div>
                    </div>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="mt-1 text-gray-600">{category.description || 'No description'}</p>
                                    )}
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        {isEditing ? (
                                            <select
                                                value={formData.type}
                                                onChange={(e) => setFormData({ ...formData, type: e.target.value as 'simple' | 'special' })}
                                    ...
                                    <div>
                                        ...
                                        {isEditing ? (
                                            ...
                                            <p className="mt-1 text-gray-600">{category.displayOrder}</p>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <p className="mt-1 text-gray-600 break-all">{category.picture || 'No image'}</p>
                                    )}
                                </div>
                            </CardContent>
                        </Card>
                                                ...
                                                <TableRow key={product.id}>
                                                    <TableCell>
                                                        <div className="flex items-center gap-3">
                                                            <img
                                                                src={product.multimedia?.images[0]?.url || DEFAULT_PRODUCT_IMAGE}
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-gray-500">{product.info.description || 'No description'}</p>
                                                            </div>
                                                        </div>
                                                    </TableCell>
                                                    <TableCell>
                                                    ...
                                                    <TableCell>
                                                        <Badge variant={product.inventory.stockQuantity > product.inventory.minimumStockQuantity ? 'success' : 'warning'}>
                                                            {product.inventory.stockQuantity} units
                                                        </Badge>
                                                    </TableCell>
                                                    <TableCell>
                                                        <Badge variant={product.info.isPublished ? 'success' : 'secondary'}>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="aspect-square bg-gray-100 rounded-lg overflow-hidden mb-4">
                                    <img
                                        src={isEditing ? (formData.picture || DEFAULT_CATEGORY_IMAGE) : (category.picture || DEFAULT_CATEGORY_IMAGE)}
                                        alt={category.name}
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    {isEditing ? (
                                        ...
                                        <Badge variant={category.showOnHomepage ? 'success' : 'secondary'}>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    {isEditing ? (
                                        ...
                                        <Badge variant={category.showOnNavbar ? 'success' : 'secondary'}>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-3">
                                <div className="flex justify-between items-center">
                                    ...
                                    <Badge variant="default">{category.productIds?.length || 0}</Badge>
                                </div>
                                <div className="flex justify-between items-center">
                                    <span className="text-sm text-gray-600">Subcategories</span>
                                    <Badge variant="default">{category.subCategories?.length || 0}</Badge>
                                </div>
                            </CardContent>
                        </Card>
