                ...
                <div className="p-6 space-y-6">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
                      ...
                      Assign Products ({formData.selectedProductIds.length}{" "}
                      selected)
                    </h3>
                    ...
                    <div className="max-h-[400px] overflow-y-auto border border-gray-200 rounded-lg">
                      {availableProducts.length === 0 ? (
                        <div className="p-6 text-center text-gray-500">
                          ...
                          <p className="text-sm">
                            Create products first to assign them to categories
                          </p>
                        </div>
                      ) : (
                        <div className="divide-y divide-gray-200">
                          {availableProducts.map((product) => (
                            <label
                              ...
                              <input
                                type="checkbox"
                                checked={formData.selectedProductIds.includes(
                                  product.id
                                )}
                                onChange={() =>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="mt-1">
                      <Badge
                        variant={
                          viewingCategory.isPublished ? "success" : "secondary"
                        }>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-600">
                      {viewingCategory.productIds.length} product(s)
                    </p>
                  </div>
                </div>
                ...
                {viewingCategory.parentId && (
                  <div>
                    ...
                    <p className="mt-1 text-gray-600">
                      {categories.find((c) => c.id === viewingCategory.parentId)
                        ?.name || "N/A"}
                    </p>
                  </div>
                )}
