...
import { ArrowLeft, Edit, Trash2, Package, Calendar, Truck, FileText, DollarSign } from 'lucide-react';
...
export default function CartonDetailPage({ params }: { params: { id: string } }) {
    ...
    const handleDelete = async () => {
        ...
        if (!confirm(`Are you sure you want to delete carton ${carton.cartonNumber}? This action cannot be undone.`)) {
            return;
        }
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold">{formatCurrency(carton.totalCost)}</p>
                                </div>
                        ...
                        {carton.notes && (
                            <div className="flex items-start gap-3 pt-4 border-t">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-gray-900 whitespace-pre-wrap">{carton.notes}</p>
                                </div>
                            </div>
                        )}
                    </CardContent>
                            ...
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {carton.products.map((product, index) => (
                                        <tr key={index} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 text-right">{formatCurrency(product.costPerUnit)}</td>
                                ...
                                <tfoot className="bg-gray-50 font-semibold">
                                    <tr>
                                        ...
                                        <td className="px-6 py-4 text-right">{carton.totalQuantity}</td>
