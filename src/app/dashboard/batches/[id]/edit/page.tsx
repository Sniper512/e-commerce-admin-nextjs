...
export default function EditBatchPage() {
    ...
    const validateForm = (): boolean => {
        ...
        if (formData.remainingQuantity > formData.quantity) {
            newErrors.remainingQuantity = 'Remaining quantity cannot exceed initial quantity';
        }
                                    ...
                                    <div>
                                        ...
                                        <ProductSearchDropdown
                                            availableProducts={products.map(p => ({
                                                ...
                                                image: p.multimedia?.images?.[0]?.url || '/images/default-product.png'
                                            }))}
                                        ...
                                        {selectedProduct && (
                                            <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg flex items-center gap-3">
                                                {selectedProduct.multimedia?.images && selectedProduct.multimedia.images.length > 0 && (
                                                    <img
                                                ...
                                                <div>
                                                    <p className="font-medium text-sm">{selectedProduct.info.name}</p>
                                ...
                                <CardContent className="space-y-4">
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) =>
                                                    handleInputChange('remainingQuantity', parseInt(e.target.value) || 0)
                                                }
                                    ...
                                    <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                                        <p className="text-sm text-blue-800">
                                            <strong>Used:</strong>{' '}
                                            {(formData.quantity - formData.remainingQuantity).toLocaleString()}{' '}
                                            units (
                                            {Math.round(((formData.quantity - formData.remainingQuantity) / formData.quantity) * 100) || 0}
                                            % utilized)
                                        </p>
                                    </div>
                                </CardContent>
                                ...
                                <Card className="border-red-200 bg-red-50">
                                    <CardContent className="pt-6">
                                        <div className="flex gap-3">
                                            ...
                                            <div>
                                                <h4 className="font-medium text-red-900 mb-1">Recalled Batch</h4>
                                                <p className="text-sm text-red-800">
                                                    This batch is marked as recalled. Please ensure all affected
